...
?>
<form action="/10%20-%2021/forms-%2021/forms/process.php" method="get">
...
<form action="/10%20-%2021/forms-%2021/forms/process.php" method="post" enctype="multipart/form-data">
    <input type="text" name="username" placeholder="Введите ваше имя">
    <input type="email" name="email" placeholder="Введите ваш email">
    <select name="gender">
